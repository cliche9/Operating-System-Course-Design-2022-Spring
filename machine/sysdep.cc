...
#else
int select(int numBits, Thread *readFds, Thread *writeFds, Thread *exceptFds, 
	struct timeval *timeout);
#endif
#endif
...
//extern int recvfrom(int s, Thread *buf, int len, int flags, Thread *from, int *fromlen);
//extern int sendto(int s, Thread *msg, int len, int flags, Thread *to, int tolen);
